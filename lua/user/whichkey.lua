...
local mappings = {
  ...
  ["q"] = { "<cmd>q!<CR>", "Quit" },
  ["`"] = { "<cmd>nohlsearch<CR>", "Highlight Erase" },
  ["f"] = {
  ...
  c = {
    ...
    p = { "<cmd>normal @c<cr>", "Fireplace Eval(cljs)" },
  ...
  d = {
    ...
    h = { "<cmd> highlight RedundantSpaces ctermbg=red guibg=red | match RedundantSpaces /\\s\\+$/<cr>", "Highlight Trailing Spaces" },
