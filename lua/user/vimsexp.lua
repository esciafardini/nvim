...
function! s:vim_sexp_mappings()
  ...
  xmap <silent><buffer> <M-a>              <Plug>(sexp_outer_list)
  omap <silent><buffer> <M-a>              <Plug>(sexp_outer_list)
  xmap <silent><buffer> <M-f>              <Plug>(sexp_inner_list)
  omap <silent><buffer> <M-f>             <Plug>(sexp_inner_list)
  xmap <silent><buffer> <M-S-a>              <Plug>(sexp_outer_top_list)
  omap <silent><buffer> <M-S-a>              <Plug>(sexp_outer_top_list)
  xmap <silent><buffer> <M-S-f>              <Plug>(sexp_inner_top_list)
  omap <silent><buffer> <M-S-f>              <Plug>(sexp_inner_top_list)
